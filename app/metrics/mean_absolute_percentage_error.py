...
class MeanAbsolutePercentageError(MetricBase):
    """
    Mean absolute percentage error metric class.
    ...
    def info(self) -> dict:
        return {
            ...
            "link": "https://scikit-learn.org/stable/modules/generated/sklearn.metrics.mean_absolute_percentage_error.html",
            "parameters": [
                {
                    "name": "sample_weight",
    ...
    def calculate(
        ...
        """
        try:
            return sk_metrics.mean_absolute_percentage_error(
                y_true=expected,
                y_pred=out,
